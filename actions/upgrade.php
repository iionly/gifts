<?php
/**
 * Gifts plugin upgrade action
 */

$plugins_path = elgg_get_plugins_path();

require_once "{$plugins_path}gifts/version.php";

$local_version = elgg_get_plugin_setting('up_version', 'gifts');

if ($version <= $local_version) {
	return elgg_error_response(elgg_echo('gifts:upgrade:not_required'));
}

set_time_limit(0);

$base_dir = "{$plugins_path}gifts/upgrades";
...
return elgg_ok_response('', elgg_echo('gifts:upgrade:success'), REFERER);
